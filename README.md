...
| **Add the A-CODE binder benchmark** — 10-target conditional binder-design test set, generation on a Stage III checkpoint, AF2 initial-guess folding in its own environment, and the Designability filter | [`docs/conditional_binder_design_benchmark.md`](docs/conditional_binder_design_benchmark.md), [`pxdesign_train/benchmarks/`](pxdesign_train/benchmarks/), [`scripts/evaluation/eval_conditional_binder_benchmark.py`](scripts/evaluation/eval_conditional_binder_benchmark.py), [`scripts/evaluation/fold_af2ig.py`](scripts/evaluation/fold_af2ig.py), [`scripts/utilities/bootstrap_af2ig.sh`](scripts/utilities/bootstrap_af2ig.sh), [`tests/test_conditional_binder_benchmark.py`](tests/test_conditional_binder_benchmark.py), [`tests/test_af2ig_scoring.py`](tests/test_af2ig_scoring.py) |
