...
TRAIN_ONLY = {
    ...
    "cross_neighbors": "neighbourhood size for S_phi's cross-residue attention, "
                       "baked in at construction; the sampler calls the same "
                       "SideChainModule instance so it inherits the choice",
