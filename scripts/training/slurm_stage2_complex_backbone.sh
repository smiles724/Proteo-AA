#!/bin/bash
#SBATCH --job-name=proteo-aa-s2-bb
...
#SBATCH --output=logs/training/stage2_complex_backbone/%x-%j.out
#SBATCH --error=logs/training/stage2_complex_backbone/%x-%j.err
...
RUN_ROOT="${RUN_ROOT:-/hai/scratch/yfsun/proteo_aa_runs/stage2_complex_backbone/${SLURM_JOB_ID:-manual}}"
