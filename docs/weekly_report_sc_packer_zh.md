...
真正的差距在数据量。** 过程中发现并修掉 3 个不报错的静默错误，其中 1 个
推翻了上一轮已经写进文档的结论。
...
**① 两条序列条件都没买到东西。**（449 条，统一估计器，symmetry_rmsd）

| | none | plm | a_token | 差值 |
|---|---|---|---|---|
| | 1.611 | 1.612 | 1.593 | a_token −0.018 Å，plm +0.001 Å |

chi 指标上三臂几乎重合（chi1_acc 0.797 / 0.794 / 0.797）。a_token 的
0.018 Å 略大于训练末期抖动（epoch 129–199 区间 0.006），但**单 seed，
最多算微弱迹象**，不足以支持"a_token 有用"。
...
| metric | apm_ckpt | apmdata_none | apmdata_plm | apmdata_a_token | ours_none | ours_plm | dunbrack_template |
|---|---|---|---|---|---|---|---|
| symmetry_rmsd ↓ | **1.3472** | 1.6108 | 1.6117 | 1.5932 | 1.3521 | **1.3432** | 2.0415 |
| chi_recovery_40° ↑ | **0.7869** | 0.7270 | 0.7257 | 0.7268 | 0.7314 | 0.7347 | 0.6754 |
| chi_recovery_20° ↑ | **0.6780** | 0.6023 | 0.6027 | 0.5996 | 0.5712 | 0.5761 | 0.5761 |
| chi1_accuracy_40° ↑ | **0.8551** | 0.7969 | 0.7944 | 0.7968 | 0.8010 | 0.8040 | 0.7207 |
| chi1+chi2_acc_40° ↑ | **0.7264** | 0.6406 | 0.6350 | 0.6416 | 0.6406 | 0.6476 | 0.5529 |
| rotamer_recovery ↑ | **0.6845** | 0.6047 | 0.6027 | 0.6033 | 0.6117 | 0.6161 | 0.5489 |
| bond_mae | 0.0005 | 0.0005 | 0.0005 | 0.0005 | 0.0005 | 0.0005 | 0.0005 |
| bad_bond_fraction | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
