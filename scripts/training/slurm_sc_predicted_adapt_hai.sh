#!/usr/bin/env bash
#SBATCH --job-name=sc-predicted-adapt
...
export OUTPUT_DIR=${OUTPUT_DIR:-/hai/scratch/yfsun/proteo_aa_runs/sc_predicted_adapt/${SLURM_JOB_ID:-dry-run}}
